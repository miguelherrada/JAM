...
#Guardamos las cosas
with open('jacobianos/FAb.pkl', 'wb') as archivo:
...
with open('jacobianos/DFAb.pkl', 'wb') as archivo:
...
#Guardamos las cosas
with open('jacobianos\DFAl.pkl', 'wb') as archivo:
    pickle.dump(DFAl, archivo)
with open('jacobianos\FAl.pkl', 'wb') as archivo:
...
#Guardamos las cosas
with open('jacobianos/DFAr.pkl', 'wb') as archivo:
    pickle.dump(DFAr, archivo)
with open('jacobianos/FAr.pkl', 'wb') as archivo:
